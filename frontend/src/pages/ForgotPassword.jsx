      ...
      <div className="min-h-screen bg-gradient-to-tr from-[#1A2B2A] via-[#0F1E1E] to-[#2D3F3E] flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl font-medium text-white/90">Check your email</h2>
            <p className="text-sm text-gray-400 mt-2">
              If an account with <span className="text-white/80">{email}</span> exists,
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-white/5 border border-white/10 text-white font-medium rounded-xl py-3 text-sm transition-all hover:bg-white/10"
            >
              Send another email
            </button>
            <Link
              to="/login"
              className="flex items-center justify-center gap-1.5 w-full text-sm text-[#7BC4BE] hover:underline font-semibold"
            >
    ...
    <div className="min-h-screen bg-gradient-to-tr from-[#1A2B2A] via-[#0F1E1E] to-[#2D3F3E] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-medium text-white/90">Forgot your password?</h2>
