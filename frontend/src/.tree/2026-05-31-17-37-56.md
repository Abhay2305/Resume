...
> **Generated:** 2026 05 31 05:37:56 PM UTC+5:30  
> **Files included:** 16  
> **Files skipped:** 1  
> **Files excluded:** 1  
> **Repo size:** 110.14 KB  
> **Est. token count:** ~28,570 tokens  
      ...
      <div className="hero">
        <div>
          ...
          <div className="hero-ctas anim-fadeUp delay-5">
            <button className="btn-hero">Build my resume <span style={{ fontSize: "1.1rem" }}>→</span></button>
            <button className="btn-hero-sec"><span style={{ fontSize: "1rem" }}>▶</span> Watch demo</button>
          </div>
        </div>

        {/* HERO VISUAL */}
        <div className="hero-visual anim-fadeIn delay-4">
            {/* The rest of the Hero Visual Code (Resume Card, ATS Badge, etc.) goes here */}
            {/* Omitted for brevity in this block, paste your exact visual code here */}
        </div>
      </div>
    </section>
  );
